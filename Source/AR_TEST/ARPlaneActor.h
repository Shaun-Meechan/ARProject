...
UCLASS()
class AR_TEST_API AARPlaneActor : public AActor
{
	GENERATED_BODY()
...
public:
	...
	/* The procedural mesh component with collision */
	UPROPERTY(Category = GoogleARCorePlaneActor, EditAnywhere, BlueprintReadWrite)
		class UProceduralMeshComponent* PlanePolygonMeshComponentCollision;
